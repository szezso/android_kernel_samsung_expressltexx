...
#endif
#if !defined(CONFIG_MACH_MELIUS) && !defined(CONFIG_MACH_SERRANO) && !defined(CONFIG_MACH_EXPRESS) && !defined(CONFIG_MACH_GOLDEN) && !defined(CONFIG_MACH_LT02) && !defined(CONFIG_MACH_WILCOX_EUR_LTE)
